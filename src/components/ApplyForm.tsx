    ...
    <AnimatePresence>
      {open && (
        <motion.div
          ...
          className="fixed inset-0 z-[60] flex items-center justify-center bg-ink/90 px-4 backdrop-blur-sm"
          onClick={onClose}
        >
          <motion.div
            ...
            className="relative w-full max-w-xl border border-line bg-ink-soft p-8 sm:p-12"
          >
            <button
              onClick={onClose}
              aria-label="Close"
